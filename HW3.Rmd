...
author: "Kenny Flagg and Paul Harmon"
date: ''
output: pdf_document
word_document:
  fig_height: 7
...
```{r problem 1}
weather = read.csv("https://dl.dropboxusercontent.com/u/77307195/rawbozemandata.csv", header = TRUE)
...
plot(weather$Yearfrac, lm.weather$residuals, pch = 20, col = "orange4", main = "Residuals vs. Year", xlab = "Year", ylab = "Residuals")
