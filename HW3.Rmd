...
```{r problem 7}
lm.poly.1 = lm(median.temp.anom ~ poly(hadcrut$yearfrac,2,raw = FALSE), data = hadcrut) poly(hadcrut$yearfrac,2,raw = FALSE)
...
```{r}
plot(lm.poly.1)
plot(hadcrut$yearfrac,resid(lm.poly.1), main = "Residuals vs.Time)
```
